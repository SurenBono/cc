...
const char* crypto = "https://api.coingecko.com/api/v3/simple/price?ids=bitcoin,cardano,curve-dao-token,litecoin,matic-network,stellar,verus-coin&vs_currencies=usd";
...
void fetchRig() {
  ...
  {Serial.println("...Rig parse failed!");}
    ...
    lcd.setCursor(0,0);lcd.print(Hash);
	  lcd.setCursor(10,0);lcd.print("Shre "+ String(Share,0));
	...
	Serial.println("Komodo Wallet Bal : " + String(Komodo,6) + " VRSC =" + " USD $ "+ String(vrscUSD,2));
  Serial.println("====================================================================================");
...
void fetchPrice(){
  ...
  {Serial.println("...parse price failed!");Serial.println();}
    ...
    Serial.print("BTC " + btcPrice);
	  ...
	  Serial.print(" CRV " + String(crvPrice,2));
    ...
    lcd.clear();
    lcd.setCursor(0,0);lcd.print("CRPT$USD ");
	  lcd.setCursor(10,0);lcd.print("BTC " + btcPrice);
	  lcd.setCursor(0,1);lcd.print("ADA " + String(adaPrice,2));
	  lcd.setCursor(10,1);lcd.print("CRV " + String(crvPrice,2));
	  lcd.setCursor(0,2);lcd.print("MAT " + String(matPrice,2));
	  lcd.setCursor(10,2);lcd.print("XLM " + String(xlmPrice,2));
