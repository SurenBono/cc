// komodo wallet rig stat + pi-network update
...
const char* crypto = "https://api.coingecko.com/api/v3/simple/price?ids=bitcoin,bitget-token,cardano,ethereum,litecoin,pi-network,solana,verus-coin,worldcoin-wld&vs_currencies=usd";
...
void fetchPrice(){
  ...
  {Serial.println("...parse price failed!");Serial.println();lcd.clear();("...reparsing price");}
   ...
   // float xrpPrice = root["ripple"]["usd"];
    ...
    Serial.println("   ADA " + String(adaPrice,2));
